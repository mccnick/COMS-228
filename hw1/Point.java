...
public class Point implements Comparable<Point>
{
	 ...
	 * variable xORy
	 * 
	 * @param q the point to compare with
	...
	public int compareTo(Point q)
	{
		...
		{
			return -1; // this point is less than point q
		}
		else if (this.x == q.x && this.y == q.y)
		{
			return 0; // this point is equal to point q
		}
		else
		{
			return 1; // this point is greater than point q
		}
	}
